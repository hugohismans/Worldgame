...
export const fr = {
  ...
  modeMottoHint: 'Sa devise est « Ordem e Progresso »',
  ...
  clueMottoAny: 'Trouve un pays dont la devise est',
  clueMottoOne: 'Trouve le pays dont la devise est',
  correct: 'Bravo',
...
export const en: Dictionary = {
  ...
  modeMottoHint: 'Its motto is “Ordem e Progresso”',
  ...
  quote: (text: string) => `\u201c${text}\u201d`,
  clueMottoAny: 'Find a country whose motto is',
  clueMottoOne: 'Find the country whose motto is',
  correct: 'Nice',
